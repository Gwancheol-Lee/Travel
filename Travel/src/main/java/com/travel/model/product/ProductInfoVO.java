...
public class ProductInfoVO {
	...
	public String toString() {
		return "ProductVO [ CATE_ID = " + cate_id + ", PRD_DATE = " + prd_date + ", PRD_NAME = " + prd_name
				+ ", PRD_ID = " + prd_id + ", PRD_PRICE = " + prd_price + ", PRD_IMG = " + prd_img + ", PRD_DELIVERY = "
				+ prd_delivery + ", PRD_STOCK = " + prd_stock + ", PRD_OPTION = " + prd_option + ", PRD_DISCOUNT = "
				+ prd_discount + ", PRD_EXPLAIN = " + prd_explain + " ]";
	}
