...
import com.travel.model.cart.ProductCartService;
import com.travel.model.cart.ProductCartVO;
import com.travel.model.member.MemberVO;
import com.travel.model.payment.PaymentService;
...
public class ProductCartController {
	...
	public String payment(@RequestParam(value = "hiddenbtn") String hidden, PaymentVO vo, HttpSession session,
			Model model) {
