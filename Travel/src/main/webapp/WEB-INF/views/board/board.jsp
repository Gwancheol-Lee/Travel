...
<link rel="stylesheet" type="text/css"
	...
	<link href="resources/bs/assets/css/boardList.css" rel="stylesheet" type="text/css" />
		...
		<tr>
			...
			<th class="tread">조회</th>		
				...
				<!--	<input type="hidden" id="show" value="${row.show}"/>	 -->
					...
					<tr style="font-family: -apple-system,BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue , Arial , Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji";>
			...
			<div id="write">
				...
				<button class="btn" id="boardWrite" onclick="location.href='write'">글쓰기</button>
				</c:if>
			</div>
			...
			<!-- 검색 조건 뷰 -->
			<form action="board" class="boardSearch" align="center" style="margin: 20px">
