...
<center>
	...
	<table class="editor">
		...
		<tr class="writer">
			<th scope="row">작성자</th>
			<td align="left" style="padding-left: 13px;">${member.member_id}</td>
		</tr>
        <tr>
            <th scope="row">제목</th>
        ...
        <tr>
            ...
            <td>
                <textarea id="content" name="content" style="width:762px; height:500px; "></textarea>
			<script>
   		...
   		<div class="write_button" style="margin-top : 10px">
			<button type="button" class="btn" id="btnWrite" onclick="createB()">작성</button>
